...
pull/reset/clean 任何 Desktop 项目。随后从受管源运行 Core setup、global binding、Doctor，并原子安装
...
唯一期望身份，再通过 Codex JSON CLI、clean tracked Marketplace snapshot、可选 legacy install metadata、Plugin cache、
