...
class GlobalOwnerScoutV55Tests(unittest.TestCase):
    ...
    def test_deployment_pack_keeps_proof_layers_separate(self) -> None:
        desired = {
            ...
            "bootstrap_version": "2.2.3", "bootstrap_sha256": "c" * 64,
            "scout_version": "5.9.1", "scout_sha256": "d" * 64,
        }
        source_sha = "e" * 64
        pack = self.managed_sources.build_deployment_pack(
            ...
            host_materialization={
                ...
                "bootstrap_skill": {"status": "unchanged", "version": "2.2.3", "content_sha256": "c" * 64},
                "scout_skill": {"status": "unchanged", "version": "5.9.1", "content_sha256": "d" * 64},
            },
        ...
        self.assertEqual("2.2.3", validated["desired_bundle"]["bootstrap_version"])
    ...
    def test_cold_start_anchor_and_plugin_do_not_embed_host_identity(self) -> None:
        ...
        if marketplace.is_file():
            ...
            self.assertEqual("v0.3.15", value["plugins"][0]["source"]["ref"])
        else:
            self.assertTrue(
    ...
    def test_v5_prompt_has_no_fixed_binding(self) -> None:
        prompt = (
            ...
            "Skill 5.9.1; global_owner_scout_project_v5; global_owner_scout_review_pack_v6; "
    ...
    def test_installed_scout_contains_and_runs_delivery_helper(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            self.assertEqual("5.9.1", installed["version"])
