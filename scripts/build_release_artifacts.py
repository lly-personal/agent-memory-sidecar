    ...
    with tempfile.TemporaryDirectory() as temporary:
        ...
        with zipfile.ZipFile(portable) as archive:
            ...
            required = {
                ...
                "plugins/agent-memory-sidecar/skills/engineering-contract-review/SKILL.md",
                "plugins/agent-memory-sidecar/skills/engineering-contract-review/agents/openai.yaml",
                "plugins/agent-memory-sidecar/skills/engineering-contract-review/references/design.md",
                "plugins/agent-memory-sidecar/skills/engineering-contract-review/references/verify.md",
                "plugins/agent-memory-sidecar/skills/engineering-contract-review/references/recover.md",
                "plugins/agent-memory-sidecar/skills/engineering-contract-review/references/performance.md",
