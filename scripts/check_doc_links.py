...
ACTIVE_DOCUMENTS = (
    ...
    ROOT / "docs" / "sops" / "workstation-reconcile.zh.md",
    ...
    ROOT / "docs" / "decisions" / "0080-consumer-visible-skill-scope-reconciliation.zh.md",
    ...
    ROOT / "specs" / "workstation-reconcile-v2.md",
