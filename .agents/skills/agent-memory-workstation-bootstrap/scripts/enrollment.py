...
def validate_prompt(text: str) -> None:
    ...
    required = ["global-owner-scout", "project_scout", "5.8.0", "72", "global_owner_scout_project_v5", "global_owner_scout_review_pack_v5", "gpt-5.6-sol", "medium"]
...
def self_test() -> None:
    ...
    try:
        ...
        pass
    good_prompt = "Use $global-owner-scout mode project_scout Skill 5.8.0 rolling 72 hours global_owner_scout_project_v5 global_owner_scout_review_pack_v5 gpt-5.6-sol medium read-only"
